...
- Do not ask `evidence_structuring` to inspect every raw artifact manually.
- Do not ask `evidence_structuring` to call `read_file`, `ls`, or `glob` for raw evidence artifacts.
